    ...
    <div class="container1">
        ...
        ?>
            ...
            <tr>
                ...
                <td><?php echo $mostrar['idUsuario']  ?></td> <!-- $consulta2 = mostrarUsuariodelComentario($conexion,$mostrar['idcomentarios']); $usuarioComentario=mysqli_fetch_array($consulta)){ $usuarioComentario['idUsuario'] } -->
