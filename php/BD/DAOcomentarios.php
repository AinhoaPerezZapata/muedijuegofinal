...
function aceptarComentario($conexion, $idcomentarios){
...
function mostrarComentario($conexion,$idNoticias){
        $consulta = "SELECT * FROM comentarios WHERE idNoticias=$idNoticias";
        $resultado = mysqli_query($conexion, $consulta);
        return $resultado;
    }
?>